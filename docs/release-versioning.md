...
plus an exact `platform-root` distribution Application. `platform-root` follows `v1.1.1` and owns
...
platform-components `v1.1.0 -> v1.1.1` deliberately changes the distribution Application; compatible
